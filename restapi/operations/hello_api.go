...
func NewHelloAPI(spec *loads.Document) *HelloAPI {
	return &HelloAPI{
		...
		HelloTagIDOfHelloEndpointHandler: hello_tag.IDOfHelloEndpointHandlerFunc(func(params hello_tag.IDOfHelloEndpointParams) middleware.Responder {
			return middleware.NotImplemented("operation hello_tag.IDOfHelloEndpoint has not yet been implemented")
		}),
	}
}

/*HelloAPI Documentation of our hello API. */
type HelloAPI struct {
	...
	// HelloTagIDOfHelloEndpointHandler sets the operation handler for the id of hello endpoint operation
	HelloTagIDOfHelloEndpointHandler hello_tag.IDOfHelloEndpointHandler
...
func (o *HelloAPI) Validate() error {
	...
	if o.HelloTagIDOfHelloEndpointHandler == nil {
		unregistered = append(unregistered, "hello_tag.IDOfHelloEndpointHandler")
	}
...
func (o *HelloAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/hello"] = hello_tag.NewIDOfHelloEndpoint(o.context, o.HelloTagIDOfHelloEndpointHandler)
}
